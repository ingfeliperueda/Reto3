...
public class ClientController {
    ...
    public Optional<ClientModel> getClient(@PathVariable("id") int id){
        return clientService.getClientModel(id);
    }
    
    @PostMapping("/save")
    @ResponseStatus(HttpStatus.CREATED)
    public ClientModel save(@RequestBody ClientModel l){
        return clientService.save(l);
    }
    
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public ClientModel update(@RequestBody ClientModel l) {
